...
from .DeformConv2d_sphe import DeformConv2d_sphe2
...
class RAFT_sphe(nn.Module):

    def __init__(self, args):
        super(RAFT_sphe, self).__init__()
        self.args = args
...
class BasicUpdateBlock(nn.Module):
    ...
    def __init__(self, args, hidden_dim=128, input_dim=128):
        ...
        self.mask = nn.Sequential(
            ...
            DeformConv2d_sphe2(128, 256, 3, padding=1), nn.ReLU(inplace=True),
...
class BasicEncoder(nn.Module):
    ...
    def __init__(self, output_dim=128, norm_fn='batch', dropout=0.0, dcn=False):
        ...
        if dcn:
            ...
            # self.conv1 = DeformConv2d_sphe2(3, 64, kernel_size=7, stride=2, padding=3)
...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, norm_fn='group', stride=1):
        ...
        # self.conv1 = DeformConv2d_sphe2(
        #     in_planes, planes, kernel_size=3, padding=1, stride=stride)
        # self.conv2 = DeformConv2d_sphe2(planes, planes, kernel_size=3, padding=1)
...
class BasicMotionEncoder(nn.Module):
    ...
    def __init__(self, args):
        ...
        # self.convc2 = DeformConv2d_sphe2(256, 192, 3, padding=1)
        # self.convf1 = DeformConv2d_sphe2(2, 128, 7, padding=3)
        # self.convf2 = DeformConv2d_sphe2(128, 64, 3, padding=1)
        # self.conv = DeformConv2d_sphe2(64 + 192, 128 - 2, 3, padding=1)
...
class SepConvGRU(nn.Module):
    ...
    def __init__(self, hidden_dim=128, input_dim=192 + 128):
        ...
        # self.convz1 = DeformConv2d_sphe2(
        #     hidden_dim + input_dim, hidden_dim, (1, 5), padding=(0, 2))
        # self.convr1 = DeformConv2d_sphe2(
        #     hidden_dim + input_dim, hidden_dim, (1, 5), padding=(0, 2))
        # self.convq1 = DeformConv2d_sphe2(
        #     hidden_dim + input_dim, hidden_dim, (1, 5), padding=(0, 2))

        # self.convz2 = DeformConv2d_sphe2(
        #     hidden_dim + input_dim, hidden_dim, (5, 1), padding=(2, 0))
        # self.convr2 = DeformConv2d_sphe2(
        #     hidden_dim + input_dim, hidden_dim, (5, 1), padding=(2, 0))
        # self.convq2 = DeformConv2d_sphe2(
        #     hidden_dim + input_dim, hidden_dim, (5, 1), padding=(2, 0))
...
class FlowHead(nn.Module):
    ...
    def __init__(self, input_dim=128, hidden_dim=256):
        ...
        # self.conv1 = DeformConv2d_sphe2(input_dim, hidden_dim, 3, padding=1)
        # self.conv2 = DeformConv2d_sphe2(hidden_dim, 2, 3, padding=1)
...
class ConvGRU(nn.Module):
    ...
    def __init__(self, hidden_dim=128, input_dim=192 + 128):
        ...
        # self.convz = DeformConv2d_sphe2(
        #     hidden_dim + input_dim, hidden_dim, 3, padding=1)
        # self.convr = DeformConv2d_sphe2(
        #     hidden_dim + input_dim, hidden_dim, 3, padding=1)
        # self.convq = DeformConv2d_sphe2(
        #     hidden_dim + input_dim, hidden_dim, 3, padding=1)
